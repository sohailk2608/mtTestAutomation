...
public class Recording {
    ...
    public void recording() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edt_username), withText("whiteelephant261"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edt_password),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("video1"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("mytaxi demo"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("mytaxi demo")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.nav_username), withText("whiteelephant261"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("whiteelephant261")));
